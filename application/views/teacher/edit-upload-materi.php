                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <?= form_error('nama_materi', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="text-editor" name="catatan">
                                        <?= $materi['catatan']; ?>
                                </textarea>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <label for="">Current file : <?= $materi['unggah_materi2']; ?></label>
                                        <div class="custom-file">
                                        ...
                                        <?= form_error('unggah_materi2', '<small class="text-danger pl-3">', '</small>'); ?>
                                    </div>
                                </div>
                            </div>
