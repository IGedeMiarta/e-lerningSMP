                        ...
                        <div class="card-body">
                            ...
                            <div class="direct-chat-messages">
                                <div class="form-group">
                                    <input type="hidden" class="form-control" name="id" id="id" value="<?= $kelas['id']; ?>" autocomplete="off">
                                    <label for="nama_kelas">Nama Kelas</label>
                                    <input type="text" class="form-control" name="nama_kelas" id="nama_kelas" value="<?= $kelas['nama_kelas']; ?>" autocomplete="off">
